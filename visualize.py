...
parser.add_argument('--group', type=str, default='site', help='Phenotypic attribute to group subjects on')
...
if __name__ == '__main__':
    ...
    plt.show()
    plt.savefig(f'./NodeEmbeddings/Node_Embeddings_{args.group}.png')
